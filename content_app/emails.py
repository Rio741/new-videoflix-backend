...
def send_password_reset_email(user_email, reset_token):
    ...
    reset_link = f"{settings.FRONTEND_URL}/reset-password/{reset_token}"  # ✅ Korrekte URL mit Token
    
    print(f"🔍 Generierter Passwort-Reset-Link: {reset_link}")  # ✅ Debugging-Ausgabe
